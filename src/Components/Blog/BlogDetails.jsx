    ...
    <div className="max-w-3xl px-6 py-16 mx-auto space-y-12">
        ...
        <div className="space-y-6">
          ...
          <div className="flex flex-col items-start justify-between w-full md:flex-row md:items-center dark:text-gray-600">
            <div className="flex items-center md:space-x-2">
              ...
              />
              <p className="text-sm">
                {name} • {new Date(published_at).toLocaleDateString()}
              </p>
            </div>
      ...
      <Tabs>
        ...
        <TabPanel>
          <div>
            <p>
              I am not focusing on ui now i will update beautifully ui later{" "}
            </p>
            <div className="dark:text-gray-800">
              ...
              />
              <p>{description}</p>
              <a href={canonical_url} className="link-neutral">
                {canonical_url}
              </a>
              <p className="mt-2 text-sm md:mt-0">
                Comments: {comments_count} • Last Comment: {last_comment_at}
              </p>
            </div>
        ...
        <TabPanel>
          <div className="pt-12 border-t dark:border-gray-300">
            <h4 className="text-lg font-semibold">Author Details</h4>
